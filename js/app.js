...
document.addEventListener('DOMContentLoaded', async function() {
  ...
  if (window.DQH.submitForm) {
    window.DQH.submitForm.init();
  }
});
...
function initDownloadCSV() {
  ...
  btn.addEventListener('click', function() {
    ...
    var cols = [
      ...
      { key: 'approvalScore', label: 'Approval Score' },
      { key: 'minStudies', label: 'Min Completed Studies' },
      { key: 'overallPassRate', label: 'Overall Pass Rate (%)' },
      { key: 'qualityDescription', label: 'Quality Measure Description' },
      { key: 'classicChecksRate', label: 'Attention Check (%)' },
      { key: 'classicChecksDescription', label: 'Attention Check Description' },
      { key: 'videoCheckRate', label: 'Video Check (%)' },
      { key: 'videoCheckDescription', label: 'Video Check Description' },
      { key: 'typedTextRate', label: 'Typed Text (%)' },
      { key: 'typedTextDescription', label: 'Typed Text Description' },
      { key: 'typicalSpeedRate', label: 'Typed with Typical Speed (%)' },
      { key: 'typicalSpeedDescription', label: 'Typed with Typical Speed Description' },
      { key: 'recaptchaRate', label: 'ReCAPTCHA Score (%)' },
      { key: 'recaptchaDescription', label: 'ReCAPTCHA Score Description' },
      { key: 'pangramRate', label: 'Pangram AI Detector (%)' },
      { key: 'pangramDescription', label: 'Pangram AI Detector Description' },
      { key: 'mouseClicksRate', label: 'Mouse Clicks (%)' },
      { key: 'mouseClicksDescription', label: 'Mouse Clicks Description' },
      { key: 'mouseMovementsRate', label: 'Mouse Movements (%)' },
      { key: 'mouseMovementsDescription', label: 'Mouse Movements Description' },
      { key: 'uniqueIpRate', label: 'Unique IP Address (%)' },
      { key: 'uniqueIpDescription', label: 'Unique IP Address Description' },
      { key: 'noForeignIpRate', label: 'No Foreign IP Address (%)' },
      { key: 'noForeignIpDescription', label: 'No Foreign IP Address Description' },
      { key: 'noGeoClusterRate', label: 'Not in a Geolocation Cluster (%)' },
      { key: 'noGeoClusterDescription', label: 'Not in a Geolocation Cluster Description' },
      { key: 'noDuplicateSubmissionRate', label: 'No Duplicate Submission (%)' },
      { key: 'noDuplicateSubmissionDescription', label: 'No Duplicate Submission Description' },
      { key: 'noDuplicateFingerprintRate', label: 'No Duplicate Device Fingerprint (%)' },
      { key: 'noDuplicateFingerprintDescription', label: 'No Duplicate Device Fingerprint Description' },
      { key: 'customMetric1Name', label: 'Custom Metric 1 Name' },
      { key: 'customMetric1Category', label: 'Custom Metric 1 Category' },
      { key: 'customMetric1Rate', label: 'Custom Metric 1 Rate (%)' },
      { key: 'customMetric1Description', label: 'Custom Metric 1 Description' },
      { key: 'customMetric2Name', label: 'Custom Metric 2 Name' },
      { key: 'customMetric2Category', label: 'Custom Metric 2 Category' },
      { key: 'customMetric2Rate', label: 'Custom Metric 2 Rate (%)' },
      { key: 'customMetric2Description', label: 'Custom Metric 2 Description' },
      { key: 'customMetric3Name', label: 'Custom Metric 3 Name' },
      { key: 'customMetric3Category', label: 'Custom Metric 3 Category' },
      { key: 'customMetric3Rate', label: 'Custom Metric 3 Rate (%)' },
      { key: 'customMetric3Description', label: 'Custom Metric 3 Description' },
      { key: 'customMetric4Name', label: 'Custom Metric 4 Name' },
      { key: 'customMetric4Category', label: 'Custom Metric 4 Category' },
      { key: 'customMetric4Rate', label: 'Custom Metric 4 Rate (%)' },
      { key: 'customMetric4Description', label: 'Custom Metric 4 Description' },
      { key: 'customMetric5Name', label: 'Custom Metric 5 Name' },
      { key: 'customMetric5Category', label: 'Custom Metric 5 Category' },
      { key: 'customMetric5Rate', label: 'Custom Metric 5 Rate (%)' },
      { key: 'customMetric5Description', label: 'Custom Metric 5 Description' },
      { key: 'customMetric6Name', label: 'Custom Metric 6 Name' },
      { key: 'customMetric6Category', label: 'Custom Metric 6 Category' },
      { key: 'customMetric6Rate', label: 'Custom Metric 6 Rate (%)' },
      { key: 'customMetric6Description', label: 'Custom Metric 6 Description' },
      { key: 'customMetric7Name', label: 'Custom Metric 7 Name' },
      { key: 'customMetric7Category', label: 'Custom Metric 7 Category' },
      { key: 'customMetric7Rate', label: 'Custom Metric 7 Rate (%)' },
      { key: 'customMetric7Description', label: 'Custom Metric 7 Description' },
      { key: 'customMetric8Name', label: 'Custom Metric 8 Name' },
      { key: 'customMetric8Category', label: 'Custom Metric 8 Category' },
      { key: 'customMetric8Rate', label: 'Custom Metric 8 Rate (%)' },
      { key: 'customMetric8Description', label: 'Custom Metric 8 Description' },
      { key: 'customMetric9Name', label: 'Custom Metric 9 Name' },
      { key: 'customMetric9Category', label: 'Custom Metric 9 Category' },
      { key: 'customMetric9Rate', label: 'Custom Metric 9 Rate (%)' },
      { key: 'customMetric9Description', label: 'Custom Metric 9 Description' },
      { key: 'customMetric10Name', label: 'Custom Metric 10 Name' },
      { key: 'customMetric10Category', label: 'Custom Metric 10 Category' },
      { key: 'customMetric10Rate', label: 'Custom Metric 10 Rate (%)' },
      { key: 'customMetric10Description', label: 'Custom Metric 10 Description' },
      { key: 'preregistration', label: 'Pre-registered' },
