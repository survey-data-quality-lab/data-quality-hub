...
function initDownloadCSV() {
  ...
  btn.addEventListener('click', function() {
    ...
    var cols = [
      ...
      { key: 'classicChecksRate', label: 'Passed Classic Checks (%)' },
      { key: 'classicChecksDescription', label: 'Classic Checks Description' },
      { key: 'videoCheckRate', label: 'Passed Video Check (%)' },
      ...
      { key: 'typicalSpeedRate', label: 'Typed w/ Typical Speed (%)' },
      { key: 'typicalSpeedDescription', label: 'Typical Speed Description' },
      { key: 'recaptchaRate', label: 'reCAPTCHA Score (%)' },
      { key: 'recaptchaDescription', label: 'reCAPTCHA Description' },
      { key: 'pangramRate', label: 'Pangram AI Likelihood (%)' },
      { key: 'pangramDescription', label: 'Pangram Description' },
      { key: 'uniqueIpRate', label: 'Unique IP Address (%)' },
      { key: 'uniqueIpDescription', label: 'Unique IP Description' },
